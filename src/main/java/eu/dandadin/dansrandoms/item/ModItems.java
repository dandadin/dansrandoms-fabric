...
public class ModItems {
    ...
    public static final Item DIAMOND_ROD = registerItem("diamond_rod", new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(DansRandoms.MOD_ID, "diamond_rod")))));
